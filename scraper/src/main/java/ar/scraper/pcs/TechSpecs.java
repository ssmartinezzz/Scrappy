 ...
 * {@code TipoAlmacenamiento.DESCONOCIDO} means "the parser didn't assert
 * this", never "no socket"/"no watts". A category only fills the fields it
 * can actually read off the name — see {@link TechSpecsParser} for which.
 */
