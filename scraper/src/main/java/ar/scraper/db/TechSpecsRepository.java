...
class TechSpecsRepository implements TechSpecsPort {
    ...
    private static final String SQL = """
            INSERT INTO producto_tech_specs (
                ...
                watts, capacidad_gb, velocidad_mhz, actualizado_at
            ) VALUES (
                ?,
    ...
    private void bind(PreparedStatement ps, String url, TechSpecs specs) throws java.sql.SQLException {
        ps.setString(1, url);
