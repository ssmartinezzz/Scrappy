...
public class CompraGamerScraper extends BaseScraper {
    public CompraGamerScraper(ScraperConfig config, String sitio, String url) {
    ...
    protected List<Product> scrape(Page page) {
        return new TechStorePage(page, config.getTimeoutMs(),
                ...
                TechStorePage.TechStoreType.COMPRAGAMER)
                .scrapeAll();
    }
}
