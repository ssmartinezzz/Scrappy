...
| F2 | Un puerto de capacidad por agregado de persistencia | 6 de 13: `CronPort`, `FavoritosPort`, `PresetPort`, `HistorialPort`, `CatalogQueryPort`, `ProductPort` |
